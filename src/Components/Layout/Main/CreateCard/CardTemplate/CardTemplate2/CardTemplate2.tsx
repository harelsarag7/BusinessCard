    ...
    return (
        <div className="CardTemplate2">
                ...
                <div className="profile-card js-profile-card">
                    ...
                    <div className="profile-card__name">{card.businessName}</div>
                    <div className="profile-card__txt">{card.businessDescription}</div>
                ...
                <defs>
                    ...
                    <symbol id="icon-email" viewBox="0 0 22 21">
                    <title>Email</title>
